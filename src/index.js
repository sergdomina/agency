...
camera.position.set(444.49, 1708.48, 872.22);
camera.quaternion.setFromEuler(new THREE.Euler(-2.81, 0.46, 2.99));
...
loader.load(
  'https://prod.spline.design/WykTBu0j2OfSSW8i/scene.splinecode',
  (splineScene) => {
